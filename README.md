...
### Проблемму нехватки ОЗУ в collab pro  я решил.
Написал функцию image_paste_x_train(), которая формирует X_train пряvj во время обучения нейронной сети.
...
Для преобразования фона я применил библиотеку Аlbumentations (https://albumentations.ai/) благодаря которой на фото налаживал эффекты дождя, солнца, тумана, 
тени, изменял значение RGB картинок, применял размытие к изображениям, применял RandomCrop и Resize.
